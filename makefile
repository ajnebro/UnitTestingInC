...
INCLUDE_DIRS = -I src -I test/unity
SRC_DIR = src
TEST_DIR = test
...
$(SRC_DIR)/stack.o: $(SRC_DIR)/stack.c $(SRC_DIR)/stack.h
	$(CC) $(CFLAGS) $(INCLUDE_DIRS) -c $(SRC_DIR)/stack.c -o $(SRC_DIR)/stack.o
...
$(TEST_DIR)/test_stack.o: $(TEST_DIR)/test_stack.c $(SRC_DIR)/stack.h $(UNITY_DIR)/unity.h
	$(CC) $(CFLAGS) $(INCLUDE_DIRS) -c $(TEST_DIR)/test_stack.c -o $(TEST_DIR)/test_stack.o

$(UNITY_DIR)/unity.o: $(UNITY_DIR)/unity.c $(UNITY_DIR)/unity.h
	$(CC) $(CFLAGS) $(INCLUDE_DIRS) -c $(UNITY_DIR)/unity.c -o $(UNITY_DIR)/unity.o
